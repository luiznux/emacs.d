;;; init-reader.el --- Initialize reading configurations   -*- lexical-binding: t -*-
;;
...
(use-package elfeed
  ...
  :bind (("C-x w" . elfeed)
         ...
         ("q" . delete-window))
  :hook (elfeed-show-mode . emacs-read-mode)
  ...
  ;; Add icons via tags
  ;; font: https://emacs-china.org/t/elfeed-nerd-icons/26125
...
(use-package newsticker
  ...
  :hook (newsticker-treeview-item-mode . emacs-read-mode)
