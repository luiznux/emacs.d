...
(treemacs-create-theme "custom-nerd-icons"
  ...
  (progn
    ...
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-faicon "nf-fa-folder" :face 'nerd-icons-lgreen) treemacs-nerd-icons-tab)
                          ...
                          :fallback 'same-as-icon)
    ;; bin
    (treemacs-create-icon :icon (format "%s%s%s" chevron-down (nerd-icons-faicon "nf-fa-folder_open" :face 'nerd-icons-lred) treemacs-nerd-icons-tab)
                          :extensions ("bin-open")
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-faicon "nf-fa-folder" :face 'nerd-icons-lred) treemacs-nerd-icons-tab)
    ...
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-mdicon "nf-md-folder_cancel" :face 'nerd-icons-dred) treemacs-nerd-icons-tab)
                          ...
                          :fallback 'same-as-icon)
    ;; build
    (treemacs-create-icon :icon (format "%s%s%s" chevron-down (nerd-icons-faicon "nf-fa-folder_open" :face 'nerd-icons-lorange) treemacs-nerd-icons-tab)
                          :extensions ("build-open")
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-faicon "nf-fa-folder" :face 'nerd-icons-lorange) treemacs-nerd-icons-tab)
    ...
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-mdicon "nf-md-folder_home" :face 'nerd-icons-dcyan) treemacs-nerd-icons-tab)
                          ...
                          :fallback 'same-as-icon)
    ;; model
    (treemacs-create-icon :icon (format "%s%s%s" chevron-down (nerd-icons-mdicon "nf-md-folder_text" :face 'nerd-icons-dcyan) treemacs-nerd-icons-tab)
                          :extensions ("model-open")
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-mdicon "nf-md-folder_text" :face 'nerd-icons-dcyan) treemacs-nerd-icons-tab)
                          :extensions ("model-closed")
                          :fallback 'same-as-icon)
    ;; controller
    (treemacs-create-icon :icon (format "%s%s%s" chevron-down (nerd-icons-mdicon "nf-md-folder_cog" :face 'nerd-icons-red) treemacs-nerd-icons-tab)
                          :extensions ("controllers-open" "controller-open")
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-mdicon "nf-md-folder_cog" :face 'nerd-icons-red) treemacs-nerd-icons-tab)
                          :extensions ("controllers-closed" "controller-closed")
                          :fallback 'same-as-icon)
    ;; services
    (treemacs-create-icon :icon (format "%s%s%s" chevron-down (nerd-icons-mdicon "nf-md-folder_settings" :face 'nerd-icons-blue) treemacs-nerd-icons-tab)
                          :extensions ("services-open" "service-open")
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-mdicon "nf-md-folder_settings" :face 'nerd-icons-blue) treemacs-nerd-icons-tab)
    ...
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-mdicon "nf-md-folder_upload" :face 'nerd-icons-yellow) treemacs-nerd-icons-tab)
                          ...
                          :fallback 'same-as-icon)
    ;; db, sql
    (treemacs-create-icon :icon (format "%s%s%s" chevron-down (nerd-icons-mdicon "nf-md-folder_table" :face 'nerd-icons-dgreen) treemacs-nerd-icons-tab)
                          :extensions ("db-open" "sql-open")
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "%s%s%s" chevron-right (nerd-icons-mdicon "nf-md-folder_table" :face 'nerd-icons-dgreen) treemacs-nerd-icons-tab)
